...
<head>
	...
	<title>western food and beverages Restaurant</title>
...
<div class="container">
	...
	<div class="row" style="margin-top: 25px;">
		<div class="col-sm-12" style="margin: auto; display: flex; max-width: 12000px; ">
			<?php 
			...
			<div class="card-body">
				...
				<div class="mx-auto d-block">
					<img class="rounded-circle mx-auto d-block" src="images/<?$data['image']=?>" alt="Card image cap" style="height: 100px; ">
